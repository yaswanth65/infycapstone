...
public partial class User
{
    ...
    public virtual ICollection<EventCategory> CreatedEventCategories { get; set; } = new List<EventCategory>();
    public virtual ICollection<EventSeries> EventSeriesList { get; set; } = new List<EventSeries>();
    public virtual ICollection<EventApprovalRequest> EventApprovalRequestsRequested { get; set; } = new List<EventApprovalRequest>();
    public virtual ICollection<EventApprovalRequest> EventApprovalRequestsReviewed { get; set; } = new List<EventApprovalRequest>();
